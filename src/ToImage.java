...
public class ToImage {
    public static void main(String[] args) {
        try {
            String sourceDir = "./papers/GCSE/June-2013/Question-paper/Questionpaper-Paper1-June2017.pdf"; // Pdf files are read from this folder
            String destinationDir = "./out"; // converted images from pdf document are saved here
